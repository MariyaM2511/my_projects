...
class MainRecommender:
    ...
    def __init__(self, data, weighting="bm25", fake_id = 999999):
        ...
        if weighting == "bm25":
            self.user_item_matrix = bm25_weight(self.user_item_matrix.T, K1=150, B=0.5).T.tocsr()   
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=100, regularization=0.004, iterations=50, num_threads=4):
        """Обучает ALS"""
